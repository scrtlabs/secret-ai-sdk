...
"""
Module Secret AI SDK Registry
Module allows SDK clients to query Secret AI infrastructure
for the deployed models and LLM instances
"""

from typing import List, Optional

from secret_ai_sdk._config import DEFAULT_LLM_MODEL, DEFAULT_LLM_URL

class RegistrySecretAI():
    """
    RegistrySecretAI is a collection of registry query methods
    """
